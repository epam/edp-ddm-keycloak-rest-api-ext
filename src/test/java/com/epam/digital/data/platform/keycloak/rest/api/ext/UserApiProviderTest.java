...
class UserApiProviderTest extends KeycloakBaseTest {
  ...
  UserApiProvider userApiProvider = new UserApiProvider(session, userFilter);

  @Test
  void searchUsersByAttributeNoHeaders() {
    SearchUserRequestDto searchUserRequestDto = new SearchUserRequestDto();
    assertThrows(NotAuthorizedException.class, ()-> userApiProvider.searchUsersByAttributes(request, searchUserRequestDto));
  }
}
